...
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{12}{images/22305141020_Syifa Desta R_Plot2d-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-027.png}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/22305141020_Syifa Desta R_Plot2d-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{12}{images/22305141020_Syifa Desta R_Plot2d-038.png}
...
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-046.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-049.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-055.png}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-056.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-058.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-063.png}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-065.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-066.png}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-067.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-070.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-071.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-076.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-077.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-078.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-079.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-081.png}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-083.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-084.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-087.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-091.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-092.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-093.png}
\begin{eulercomment}
Jika x adalah vektor yang diurutkan, dan y adalah vektor interval,
maka plot2d akan memplot rentang interval yang terisi dalam bidang.
Gaya isian sama dengan gaya poligon.
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-095.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-096.png}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-097.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-098.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/22305141020_Syifa Desta R_Plot2d-102.png}
...
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-103.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-104.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-105.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-107.png}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-108.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-109.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-110.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-111.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-112.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-113.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-114.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-115.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-116.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-117.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-118.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-119.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-122.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-123.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-124.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-128.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/22305141020_Syifa Desta R_Plot2d-130.png}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-131.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-132.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-133.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-135.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-136.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-137.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-138.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-139.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-140.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-141.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-144.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-145.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-146.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-147.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-151.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/22305141020_Syifa Desta R_Plot2d-152.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-153.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-154.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-155.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-156.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-157.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-158.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-159.png}
...
>plot2d("v"):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-160.png}
\begin{eulerprompt}
>plot2d("t",-7,7); insimg(15)
\end{eulerprompt}
\eulerimg{14}{images/22305141020_Syifa Desta R_Plot2d-161.png}
\begin{eulerprompt}
>function a(x) :=7x^6+11x^5-10x^4+3x^3-22x^2+x+17
>plot2d("a"):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-162.png}
\begin{eulerprompt}
>plot2d("x^3+y^4+2x",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{16}{images/22305141020_Syifa Desta R_Plot2d-163.png}
