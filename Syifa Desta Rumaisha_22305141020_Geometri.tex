...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-004.png}
...
>plotSegment(L,Q,"c"):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-005.png}
\begin{eulercomment}
3. Tunjukkan bahwa garis bagi sudut yang ke tiga juga melalui titik
pusat lingkaran dalam.
\end{eulercomment}
...
>color(2); plotLine(k):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-006.png}
\begin{eulercomment}
4. Gambar jari-jari lingkaran dalam.
\end{eulercomment}
\begin{eulerprompt}
>plotSegment(P,L,"r"):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-007.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Syifa Desta Rumaisha_22305141020_Geometri-009-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-015-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-019.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-021.png}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-022.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
atau bia dituliskan dalam bentuk lain:\\
\end{eulercomment}
\begin{eulerformula}
\[
L = \frac{1}{4} \sqrt(a+b+c)(b+c-a)(a+c-b)(a+b-c)\quad
\]
\end{eulerformula}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-031.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{16}{images/Syifa Desta Rumaisha_22305141020_Geometri-034.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/Syifa Desta Rumaisha_22305141020_Geometri-038-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-039.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ \left[ \frac{b^2+a^2-1}{2\,a} , \frac{b^2+a^2}{2\,a} ,   \frac{b^2+a^2-16}{2\,a} \right]  , \left[ \frac{\sqrt{-b^4+2\,a^2\,b  ^2+2\,b^2-a^4+2\,a^2-1}}{2\,a} , \frac{\sqrt{-b^4+2\,a^2\,b^2-a^4}}{  2\,a} , \frac{\sqrt{-b^4+2\,a^2\,b^2+32\,b^2-a^4+32\,a^2-256}}{2\,a}   \right]  \right] 
\]
\end{eulerformula}
\begin{eulerprompt}
>B &= [0,0]; $B, C &= [a,0]; $C
...
\]
\end{eulerformula}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-046-large.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ -\frac{4\,a^2\,b^2}{\left(b-a-1\right)\,\left(b-a+1\right)\,  \left(b+a-1\right)\,\left(b+a+1\right)} , 0 , -\frac{64\,a^2\,b^2}{  \left(b-a-4\right)\,\left(b-a+4\right)\,\left(b+a-4\right)\,\left(b+  a+4\right)} \right] 
\]
\end{eulerformula}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-050.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Syifa Desta Rumaisha_22305141020_Geometri-054-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-067.png}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-071.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-074-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-077-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-078.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/Syifa Desta Rumaisha_22305141020_Geometri-086-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-091.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-094-large.png}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-095-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Syifa Desta Rumaisha_22305141020_Geometri-098-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Syifa Desta Rumaisha_22305141020_Geometri-107-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Syifa Desta Rumaisha_22305141020_Geometri-115-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-117.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/Syifa Desta Rumaisha_22305141020_Geometri-119-large.png}
\eulerimg{1}{images/Syifa Desta Rumaisha_22305141020_Geometri-120-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-122.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-133.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-135.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-136.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-138.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-140.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-142.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-143.png}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-144.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-148.png}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-150.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-151.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-153.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-154.png}
\begin{eulercomment}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-155.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-156.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-157.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-158.png}
\begin{eulercomment}
- Batas ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-159.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-160.png}
\begin{eulercomment}
- Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-161.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{25}{images/Syifa Desta Rumaisha_22305141020_Geometri-162.png}
\eulersubheading{}
\begin{eulercomment}
TERIMAKASIH
\end{eulercomment}
